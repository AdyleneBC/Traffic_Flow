...
public class CaminoCerrador : MonoBehaviour
{
    ...
    public void CerrarCaminoDesdeTexto()
    {
        ...
        bool cerrado = CerrarCamino(nodo1, nodo2);

        if (cerrado)
        {
            Mostrar($"Camino cerrado entre {id1} y {id2}");
        }
        else
        {
            Mostrar($"No se encontró un camino abierto entre {id1} y {id2}");
        }
    }

    private bool CerrarCamino(Nodo a, Nodo b)
    {
        bool seCerro = false;
